...
@settings_schema
class Settings:
    api_id: str = setting(default="ryrrryry", description="Your Telegram API ID")
    api_hash: str = setting(default="svfas", description="Your Telegram API Hash")
    bot_token: str = setting(
        default="adfvadfv", description="Telegram bot token (either this or phone)"
    )
    bot_admin: str = setting(default="qfqrf", description="Bot admin username")
